        ...
        <main class="main-cont content mCustomScrollbar">
            ...
            <div class="page-wrap">
                ...
                <form action="addEvaluation" method="post">
                    <input type="hidden" name="scholar" value="<%= (String) session.getAttribute("scholar") %>" />
                    <input type="hidden" name="date" value="<%= new SimpleDateFormat("yyyy").format(new Date()) %>" />
                    <div class="form-group-col-2">
                        <div class="form-label">评价：</div>
                        <div class="form-cont">
                            <textarea class="form-control form-boxed" name="evaluation.content" style="width:500px;" required="" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="form-group-col-2">
