        ...
        <main class="main-cont content mCustomScrollbar">
            ...
            <div class="page-wrap">
                <section class="page-hd">
                    <header>
                        <h2 class="title">添加考勤</h2>
                    </header>
                    <hr>
                </section>
                <form action="addAttendance" method="post">
                    <input type="hidden" name="attendance.date" value="<%= new java.sql.Date(System.currentTimeMillis()) %>">
                    <div class="form-group-col-2">
                        <div class="form-label">学号：</div>
                        <div class="form-cont">
                            <input type="text" class="form-control form-boxed" name="scholar" style="width:400px;" required="">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">日期：</div>
                        <div class="form-cont">
                            <input type="date" class="form-control form-boxed" name="date" value=<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%> style="width:400px;" required="">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">签到时间：</div>
                        <div class="form-cont">
                            <input type="time" class="form-control form-boxed" name="arriveTime" style="width:400px;" required="">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">签退时间：</div>
                        <div class="form-cont">
                            <input type="time" class="form-control form-boxed" name="leaveTime" style="width:400px;" required="">
                        </div>
                    </div>
                    <div class="form-group-col-2">
